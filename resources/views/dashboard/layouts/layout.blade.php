 ...
 * @license MIT
 ...
 <head>
     ...
     <!-- Icons -->
     <link href="{{asset('adminassets/css/_animated.scss')}}" rel="stylesheet">
     ...
     <header class="navbar">
         <div class="container-fluid">
             ...
             <ul class="nav navbar-nav pull-left hidden-md-down">
                 <span>{{auth()->user()->name}}" type "{{auth()->user()->status}}" </span>
                 <li class="nav-item">
                 ...
                 <li class="nav-item dropdown">
                    ...
                    <span class="hidden-md-down">{{trans('words.settings') }}</span>
                </a>
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a class="dropdown-item" href="{{ route('dashboard.users.edit', auth()->user()) }}"><i
                            class="fa fa-user"></i> {{trans('words.user settings') }}</a>
